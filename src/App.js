...
const App = () => {
  ...
  const contractAddress = "0xA92f21736Ec8C4FA9b57719397536F38D493f18d";
  ...
  const wave = async () => {
    try {
      ...
      if (ethereum) {
        ...
        const waveTxn = await wavePortalContract.wave("awaiting msg");
...
// const App = () => {
//   const [currentAccount, setCurrentAccount] = useState("");
//   const contractAddress = "0x1a5469951F151f522Ab28c485C9634F57704dc25";
//   const contractABI = abi.abi;
